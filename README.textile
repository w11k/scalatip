...
Currently ScalaTip uses Akka 1.1-SNAPSHOT which isn't available from a public repository. Therefore, I you want to build it yourself, you first have to build Akka (the akka-actor module is sufficient) and publish it to your local repository.
